  ...
  return (
    ...
    <div className="w-1/2 p-16 flex justify-center align-middle flex-col">
      ...
      <div className="flex justify-left">
        <Button tailwindClassName="px-4 py-2 mr-4" backgroundColor="black" textColor="white">Book</Button>
        <Button tailwindClassName="border border-solid border-black text-white px-4 py-2" backgroundColor="white" textColor="black">Learn More</Button>
      </div>
    </div>
