...
const Index = ({ id }) => {
  return (
    <div className="flex flex-col items-center p-8" id={id}>
      <h1 className="text-4xl font-bold mb-4 text-center">Come get to know Buenos Aires with our City Tours</h1>
      <p className="text-lg text-center mb-8">Our seriousness and punctuality will give you security when traveling.</p>
      ...
      <div className="flex justify-center mt-2 mb-4">
        <Button isWhatsapp tailwindClassName="border border-solid border-black px-4 py-2" textColor="black" iconRight={<FaChevronRight />}>Learn more</Button>
      </div>
    </div>
  );
};
